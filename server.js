...
//db.run("INSERT into globalsynth_presets VALUES ('Default', 'Sine', 0.0, 500, 'Pink', 'Saw', 0, 'Saw', -10, 50, 50, 0, 2500, 0, 0.2, 0.6, 0.6, 0.5, 0, 0.0, 75)");
//db.run("INSERT into globalsynth_presets VALUES ('Phat Lead', 'Sine', 1.8, 113, 'Brown', 'Saw', 0, 'Saw', -19, 50, 50, 35, 2500, 6, 0.0, 0.0, 0.0, 0.0, 83, 0.0, 75)");
